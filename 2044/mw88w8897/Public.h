...
#define IOCTL_INDEX_MWIFIEXC   0x900
#define FILE_DEVICE_MWIFIEXC   65600U

#define IOCTL_MWIFIEX_GENERATE_INTERRUPT  CTL_CODE(FILE_DEVICE_MWIFIEXC,     \
                                                  IOCTL_INDEX_MWIFIEXC + 5,     \
                                                  METHOD_BUFFERED,         \
                                                  FILE_READ_ACCESS)
